...
const Main = () => {
  ...
  return (
    <section
      ...
      id='main'
      className='px-[22px] md:px-[60px] w-full h-screen mx-auto bg-no-repeat bg-center bg-[length:100%_100%] lg:px-[120px]'
    >
      ...
      <div className='w-[100%] h-screen flex flex-col gap-0 justify-around'>
        ...
        <div>
          ...
          <h1 className='text-[50px] md:text-[60px] lg:text-[110px] leading-none'>
