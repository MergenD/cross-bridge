...
export default function Industries() {
  return (
    <section
      id='industries'
      className='w-full md:px-[64px] pl-[22px] pr-[20px] pt-[60px] lg:pl-28 lg:p-0 lg:relative lg:min-h-screen lg:overflow-hidden'
    >
      <div className='flex flex-col justify-between pb-[30px] lg:flex-row lg:pb-14 lg:pr-[194px]'>
        <h1 className='text-[#008557]! text-[28px] leading-none mt-[10px] lg:text-white! lg:text-6xl lg:mt-0'>
          OUR CORE INDUSTRIES
        </h1>
        <h2 className='text-[18px] text-white lg:text-4xl lg:text-end lg:leading-none'>
          ...
          return (
            <div
              ...
              className={`group flex-none
                         ...
                         md:static
                         lg:absolute lg:top-0 lg:w-[478px] lg:h-full lg:pr-[20px] lg:flex-row lg:justify-between lg:p-6 lg:hover:w-[840px] hover:z-50
                         ${isLast ? 'lg:hover:right-0 lg:mr-0' : ''}`}
              style={{ left: leftOffset }}
            >
              <div className='flex flex-col gap-[20px] md:gap-[20px] md:justify-between w-full h-full'>
                <h3 className='text-[18px] font-medium md:text-2xl md:mb-2'>
                  {card.title}
                </h3>
                <p className='text-[12px] md:text-sm md:w-auto md:mr-[30px]'>
                  {card.body}
                </p>
                <Image
                  src={card.photo}
              ...
              <div className='hidden lg:block relative w-[40%] h-full overflow-hidden opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300'>
                <Image
                  src={card.photo}
                  alt={card.title}
