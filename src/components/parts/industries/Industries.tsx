...
export default function Industries() {
  return (
    <section
      id='industries'
      className='w-full lg:mt-[20px] pb-[60px] lg:px-120px md:px-[64px] pl-[22px] lg:pr-0 pr-[20px] pt-[60px] lg:pl-28 lg:relative lg:overflow-hidden'
    >
        ...
        {cards.map((card, i) => (
          <div
            ...
            className={`group flex-none
                        ...
                        md:static
                        lg:absolute lg:top-0 lg:w-[478px] lg:h-full lg:pr-[20px] lg:flex-row lg:justify-between lg:p-6 2xl:hover:w-[910px] lg:hover:w-[840px] hover:z-50
                        ${
                          i === cards.length - 1
